...
**Explained.** Architecture documents with diagrams, thirteen decision records naming what was rejected, operational runbooks for the failure modes that actually occur, and a backlog listing the deliberate omissions.
